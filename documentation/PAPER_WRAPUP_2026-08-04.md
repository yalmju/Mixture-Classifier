...
>
> 🔴 **LOD는 이 문서에서 확정하지 않습니다.** 세션 중 readout·blank·기준을 여러 번 바꾸며
> 서로 다른 값을 냈고(문서 4절 기록), 검량선 세트도 `Pest/Standard curves/`에 6개가 더 있어
> 어느 것이 정본인지 미정입니다. **사용자가 재계산 예정.** → `TODO.md` 1번
